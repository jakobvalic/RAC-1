...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoxMDQyNSwidXNlciI6MTE1fQ:1g1pYh:kQMbfCccc2jQOfvQJ-nmqukc_wU'
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoxMDQyNiwidXNlciI6MTE1fQ:1g1pYh:GgND-IceLPHOVO0iJDoyB6bgS9Y'
        try:
            test_data = [
                ("max_globina('burek')", 0),
