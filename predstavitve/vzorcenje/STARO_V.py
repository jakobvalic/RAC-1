...
#
# vzorciGrid, vsi_grid = gridVzorci(piksli, kvadrat * faktor_vzorca, 25)
# print('Vzorci grid:', vzorciGrid)
# izrisiTocke(vsi_grid)
# # izrisVzorcenja(vzorciGrid, kvadrat * faktor_vzorca)

    

# Random
# vzorciRandom, vsi_random = nakljucniVzorci(piksli, kvadrat*2, 9)
# # izrisiTocke(vsi_random)
# # print('Vzorci random:', vzorciRandom)
# print('Vsi vzorci random:', vsi_random)
# izrisVzorcenja(vzorciRandom, kvadrat*2)
...
vzorciJitter, vsi_jitter = gridVzorci(piksli, kvadrat * faktor_vzorca_jitter, 25)
print('Vzorci jitter:', vzorciJitter)
izrisiTocke(vsi_jitter)
# izrisVzorcenja(vzorciJitter, kvadrat * faktor_vzorca)
