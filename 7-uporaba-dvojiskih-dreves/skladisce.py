...
def stanko(vhod, izhod):
    '''Glavna funkcija, ki bere iz datoteke in napiše poročilo.'''
    with open(vhod, 'r') as f:
        with open(izhod, 'w') as g:
            vrstica = f.readline().strip()
            delo, pot, kolicina = vrstica.split()
            print(delo, pot, kolicina)

stanko('narocila1.txt', 'porocilo1111.txt')
...
def _validate_current_file():
    ...
    if Check.part():
        ...
        Check.current_part['token'] = 'eyJ1c2VyIjoxMTUsInBhcnQiOjExNDMyfQ:1eeU6S:pd9IR5tkc4hwJjBCmfB23armDz0'
