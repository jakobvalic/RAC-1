...
def intervali_najvecjih_vsot_kubicna(sez):
    '''Vrača množico parov indeksov, kjer je dosežena največja vsota.'''
    krajisca = {}
    opt = 0
    n = len(sez)
    for i in range(n):
...
def intervali_najvecjih_vsot_linearna(sez):
    '''Zaradi linearne časovne zahtevnosti, se omejimo le na en par z enakim začetko.'''
    krajisca = set()
    opt = 0
    n = len(sez)
    s = 0
    zacetek = 0
    for i in range(n): # Kje naše strnjeno podzaporedje konča
        t = s + sez[i]
        if t > 0:
            s = t
            if s > opt:
                opt = s
                krajisca.clear()
                krajisca.add((zacetek, i + 1))
            elif s == opt:
                krajisca.add((zacetek, i + 1))
        else:
            s = 0
            zacetek = i + 1 # Začnemo novo strnjeno podzaporedje
    return krajisca
...
def _validate_current_file():
    ...
    if Check.part():
        ...
        Check.current_part['token'] = 'eyJ1c2VyIjoxMTUsInBhcnQiOjExNjEzfQ:1eeU6Z:X5RbEQYFnsWr692f1GaDPn77eFo'
    ...
    if Check.part():
        ...
        Check.current_part['token'] = 'eyJ1c2VyIjoxMTUsInBhcnQiOjExNjE0fQ:1eeU6Z:PyyeXlAoRFys_uki858-U1qvih8'
    ...
    if Check.part():
        ...
        Check.current_part['token'] = 'eyJ1c2VyIjoxMTUsInBhcnQiOjExNjE1fQ:1eeU6Z:HZJDC23gTMzxuBAaFZaCeN2oVTw'
