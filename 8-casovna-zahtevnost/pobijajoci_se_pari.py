...
def nicelni_pari_v_urejenem(seznam):
    '''Pogleda, ali v urejenem seznamu celih števil obstaja par, ki se sešteje v 0.'''
    mnozica = set()
    for stevilo in seznam:
        if stevilo in mnozica:
            return True
        mnozica.add(abs(stevilo))
    return False
# =====================================================================@011731=
# 2. podnaloga
...
def nicelni_pari_v_neurejenem(seznam):
    '''Vrne podatek, ali obstaja par števil, ki se sešteje v 0.'''
    mnozica = set()
    for stevilo in seznam:
        if -1 * stevilo in mnozica:
            return True
        mnozica.add(stevilo)
    return False
...
def _validate_current_file():
    ...
    if Check.part():
        ...
        Check.current_part['token'] = 'eyJ1c2VyIjoxMTUsInBhcnQiOjExNzMwfQ:1eeU6Z:v8uqWBhrelq_UZhH-Ovx_VxbMNs'
    ...
    if Check.part():
        ...
        Check.current_part['token'] = 'eyJ1c2VyIjoxMTUsInBhcnQiOjExNzMxfQ:1eeU6Z:YX8_vRihlcnXRjBLJYKrUMtsrGI'
