...
class Drevo:
    ...
    @property
    def podatek(self):
        return self._koren[0]

    @property
    def levo(self):
        return self._koren[1]

    @property
    def desno(self):
        return self._koren[2]
...
kaj_je_delalo_in_kaj_ni = '''
    Pregledi dreves in preiskovanje dreves deluje.
'''
...
def _validate_current_file():
    ...
    if Check.part():
        ...
        Check.current_part['token'] = 'eyJ1c2VyIjoxMTUsInBhcnQiOjExMTQ4fQ:1eeU5g:0WEbmP5lhHN_YjARbAaWb3wiziI'
    ...
    if Check.part():
        ...
        Check.current_part['token'] = 'eyJ1c2VyIjoxMTUsInBhcnQiOjExMTQ5fQ:1eeU5g:lQgNH246gl-Jai6KLkd4NcP0bR0'
